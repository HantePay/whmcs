...
function hantepay_wxpay_config() {
    $configarray = [
        "FriendlyName" => [
            "Type" => "System",
            "Value"=>"Hantepay 微信支付"
...
function hantepay_wxpay_link($params){
    ...
    <div class="hantepay-container">
        <div id="hantepay_pay">
            <img src="<?php echo $systemUrl.'modules/gateways/assets/images/wxpay_logo.png';?>" alt="">
            Hantepay 微信支付
        </div>
    </div>
...
function hantepay_wxpay_refund($params){
    $Hantepay=new Hantepay();
    $time = strtotime(gmdate("Y-m-d\TH:i:s\Z"));
    $nonceStr = md5(uniqid(microtime(true),true));
    $requestParams=[
